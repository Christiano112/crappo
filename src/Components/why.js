            ...
            <section className="container why">
                <div className="row why-header">
                    <div className="col-lg-4">
                        <div className="icon">
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" color="blue" height="30" width="30" xmlns="http://www.w3.org/2000/svg" style={{ color: "blue" }}><path fill="none" d="M0 0h24v24H0z"></path><path d="M5 9.2h3V19H5zM10.6 5h2.8v14h-2.8zm5.6 8H19v6h-2.8z"></path></svg>
                        </div>
                        <div>
                            <h3>$30B</h3>
